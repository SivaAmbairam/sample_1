...
jdbc_driver_dir = r'D:\svc_webscrape\Webscrapping- Webpage V2.2 (WebSocket)\Drivers\sqljdbc_12.6.3.0_enu\sqljdbc_12.6\enu\jars\mssql-jdbc-12.6.3.jre8.jar'
...
def write_visited_log():
    ...
    if data:
        ...
        with open('Output/temp/db_connection_file.txt', 'w', encoding='utf-8') as file:
...
#         url = request.scheme + '://' + parts[0] + request.path
...
if __name__ == '__main__':
    ...
    # app.run(host='pete.flinnsci.com', debug=True)
#     app.run(host='pete.flinnsci.com', debug=True, port=80)
